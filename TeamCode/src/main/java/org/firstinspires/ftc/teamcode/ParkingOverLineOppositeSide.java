...
//(Parks on side closer to neutral bridge)

@com.qualcomm.robotcore.eventloop.opmode.Autonomous(name = "Opposite Side Park", group = "Linear Opmode")

public class ParkingOverLineOppositeSide extends LinearOpMode {
